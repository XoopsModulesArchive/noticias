...
define('_NW_REGISTER', 'コメントするにはユーザー登録を');

//%%%%%%		File Name submit.php		%%%%%
define('_NW_SUBMITNOTICIAS', 'ニュース投稿');
define('_NW_TITLE', '表題');
...
define('_NW_GO', '送信');
define('_NW_THANKS', '投稿を受付けました。当サイトスタッフによる承認を経た後に正式掲載となることをご了承ください。'); //submission of noticias article

define('_NW_NOTIFYSBJCT', 'NOTICIAS for my site'); // Notification mail subject
define('_NW_NOTIFYMSG', '新規ニュースの投稿がありました。'); // Notification mail message

//%%%%%%		File Name archive.php		%%%%%
define('_NW_NOTICIASARCHIVES', 'ニュースアーカイブ');
...
define('_AM_NOWSETEXPTIME', '設定済みの表示期限: %s');
