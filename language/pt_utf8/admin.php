...
define('_AM_CURRENTTIME', 'Definição atual: %s');
define('_AM_DAYC', 'Dia:');
...
define('_AM_NOTICIASUB', 'Novas contribuições');
define('_AM_NOTICIAS_UPDATEMODULE', 'Atualizar os esqueletos e blocos');
define('_AM_NOTICIAS_UPGRADE', 'Atualizar');
define('_AM_NOTICIAS_UPGRADECOMPLETE', 'Atualização realizada corretamente.');
define('_AM_NOTICIAS_UPGRADEFAILED', 'Houve uma falha ao tentar atualizar.');
define('_AM_NO', 'Não');
define('_AM_NOWSETEXPTIME', 'Está defenida para: %s');
define('_AM_NOWSETTIME', 'Agora está definida para: %s');
...
define('_AM_PUBLISHED', 'Publicada em');
...
define('_AM_STORYID', 'Nº identificador do notícia');
...
define('_AM_TOPICDISPLAY', 'Mostrar o ícone do tópico?');
define('_AM_TOPICIMG', 'Ícone do tópico');
define('_AM_TOPICNAME', 'Nome do tópico');
define('_AM_TOPICSMNGR', 'Gerenciamento dos tópicos');
...
define('_AM_VIEWFORM_DESC', 'Selecione quem poderá ver estes tópicos');
