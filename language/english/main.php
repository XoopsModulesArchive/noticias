...
// $Id: main.php,v 1.1 2006/03/27 15:15:37 mikhail Exp $
//%%%%%%		File Name index.php 		%%%%%
...
define('_NW_SUBMITNOTICIAS', 'Submit noticias');
...
define('_NW_GO', 'Go!');
define('_NW_THANKS', 'Thanks for your submission.'); //submission of noticias article
...
define('_NW_NOTICIASARCHIVES', 'noticias Archives');
